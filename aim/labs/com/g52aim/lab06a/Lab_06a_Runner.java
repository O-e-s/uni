...
public class Lab_06a_Runner {
	
	final Lab06aTestFrameConfig config;
	...
	public Lab_06a_Runner(Lab06aTestFrameConfig config) {
	...
	public static void main(String [] args) {
		...
		new Lab_06a_Runner(new Lab06aTestFrameConfig()).runTests();
	}
}
