...
public class DavissBitHC extends SATHeuristic {
    ...
    double bestEval = evaluate(problem);
    int[] perm = permutation(problem);
  ...
  private double evaluate(SAT problem) {
    return problem.getObjectiveFunctionValue(CURRENT_SOLUTION_INDEX);
  }

  private int[] permutation(SAT problem) {
